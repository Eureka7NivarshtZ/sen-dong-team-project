    ...
    >
      ...
      <div style={{ padding: "30px", textAlign: "left" }}>
        ...
        >
          ...
          >
            Quản lý yêu cầu & Trả lời khách hàng
          </h1>
        ...
        >
          ...
          >
            ...
            >
                  ...
                  >
                    <span
                      style={{
                        ...
                        borderRadius: "4px",
                        backgroundColor:
                          t.status === "Đã phản hồi" ? "#e8f5e9" : "#fff3e0",
                        color:
                          t.status === "Đã phản hồi" ? "#2e7d32" : "#f57c00",
                        fontWeight: "bold",
                      }}
                    >
                      {t.status}
              ...
              {filteredTickets.length === 0 && (
                ...
                >
                  Không có ticket nào thuộc danh mục này.
                </div>
              )}
            </div>
          </div>
          ...
          {activeTicket ? (
            ...
            >
              ...
              >
                <div style={{ textAlign: "left" }}>
                  ...
                  <span style={{ fontSize: "13px", color: "#666" }}>
                    Khách hàng khiếu nại: <strong>{activeTicket.sender}</strong>
                  </span>
                </div>
                <div style={{ display: "flex", gap: "8px" }}>
                  ...
                  <span
                    style={{
                      ...
                      borderRadius: "20px",
                      backgroundColor:
                        activeTicket.level === "Cao" ? "#fff0f0" : "#f5f5f5",
                      color: activeTicket.level === "Cao" ? "#ff4d4f" : "#333",
                      fontWeight: "bold",
                    }}
                  >
                    Mức độ: {activeTicket.level}
                  </span>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  >
                    📬 Khách hàng - {activeTicket.sender}
                  </span>
                  <div
                    style={{
                      backgroundColor: "#ffffff",
            ...
            >
              Vui lòng chọn một ô ticket khiếu nại bên trái để tiến hành hỗ trợ
              trả lời khách hàng
            </div>
          )}
        </div>
