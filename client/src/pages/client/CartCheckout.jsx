  ...
  const twoColumnGridStyle = {
    ...
    gridTemplateColumns: isMobile
      ...
      : isTablet
        ? "1fr 0.9fr"
        : "1.3fr 0.7fr",
    gap: isMobile ? "24px" : isTablet ? "36px" : "60px",
    alignItems: "start",
  };
        ...
        <div style={{ textAlign: "left" }}>
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            style={{
                              width: isSmallMobile ? "76px" : "90px",
                              height: isSmallMobile ? "76px" : "90px",
                              objectFit: "cover",
                              backgroundColor: "#f9f9f9",
                              borderRadius: "6px",
                              border: "1px solid #eee",
              ...
              >
                {shippingMethods.length === 0 ? (
                  ...
                  shippingMethods.map((m) => {
                    const selected =
                      String(shippingInfo.method) === String(m.id);
          ...
          {step === 5 && (
            ...
            >
              ...
              >
                Cảm ơn bạn đã ủng hộ xưởng tranh Sen Đông. Nhân viên xưởng sẽ
                sớm liên hệ qua điện thoại để xác nhận đơn hàng.
              </p>
